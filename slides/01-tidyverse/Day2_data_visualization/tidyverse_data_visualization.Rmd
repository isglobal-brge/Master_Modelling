...
6. Download genome data (https://raw.githubusercontent.com/isglobal-brge/Master_Modelling/main/data/genome.txt) into your computer and load it into RStudio by using `read_delim` function (NOTE: data are tab-delimited). 
